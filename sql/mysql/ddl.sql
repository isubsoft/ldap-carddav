...
(
	...
	card_uri VARCHAR(255) NOT NULL,
	sync_token BIGINT NOT NULL,
	CONSTRAINT cards_modify_log_fk01 FOREIGN KEY(user_id, addressbook_id, card_uri) REFERENCES cards_backend_map (user_id, addressbook_id, card_uri) ON DELETE CASCADE ON UPDATE CASCADE
);
